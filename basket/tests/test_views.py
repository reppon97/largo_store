...
class TestBasketView(TestCase):
    def setUp(self) -> None:
        ...
        Product.objects.create(category_id=1, title='title no 1', created_by_id=1, slug='title-no-1', price='20.00',
                               image='django')
        Product.objects.create(category_id=1, title='title no 2', created_by_id=1, slug='title-no-2', price='20.00',
                               image='django')
        Product.objects.create(category_id=1, title='title no 3', created_by_id=1, slug='title-no-3', price='20.00',
                               image='django')
